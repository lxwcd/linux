...
### 复制单个普通文件 不加任何选项
1. 复制文件后文件的属性改变
![1](https://img-blog.csdnimg.cn/be7317f0fb684d598535f31e4d46883e.png)

2. 有同名文件直接覆盖，即使该文件正在使用，不询问是否覆盖
![2](https://img-blog.csdnimg.cn/14275caec29c4ce9a156e12c65b3d1df.png)

### 复制单个文件 保留文件属性和修改时间
![1](https://img-blog.csdnimg.cn/52a617501e644756944a2aa9513b2fce.png)

![2](https://img-blog.csdnimg.cn/792014f183b74098bb1039d05f2f3fe7.png)
